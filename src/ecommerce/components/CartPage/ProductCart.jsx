  ...
  return (
    <li className='w-full group'>
        <div 
            ...
            lg:before:bg-transparent lg:flex-row before:bg-black/5 before:absolute before:top-0 before:left-0 before:w-full before:h-full before:rounded-md before:pointer-events-none before:z-10'>
